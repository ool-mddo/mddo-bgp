...
def register_layer3(nws)
  nws.register do
    network 'layer3' do
      ...
      bdlink %w[AS65550-1 Ethernet4 Seg_10.0.4.0/24 AS65550-1_Ethernet4]
      ...
      bdlink %w[AS65550-1 Ethernet6 Seg_10.0.3.0/24 AS65550-1_Ethernet6]
      ...
      bdlink %w[AS65550-1 Ethernet7 Seg_10.0.1.0/24 AS65550-1_Ethernet7]
      bdlink %w[endpoint01-iperf3 Ethernet1 Seg_10.0.1.0/24 endpoint01-iperf3_Ethernet1]
      ...
      bdlink %w[AS65520-1 Ethernet4 Seg_10.100.0.0/24 AS65520-1_Ethernet4]
      bdlink %w[endpoint02-iperf0 Ethernet1 Seg_10.100.0.0/24 endpoint02-iperf0_Ethernet1]
      ...
      bdlink %w[endpoint02-iperf1 Ethernet1 Seg_10.110.0.0/24 endpoint02-iperf1_Ethernet1]
      ...
      bdlink %w[AS65520-1 Ethernet5 Seg_10.120.0.0/24 AS65520-1_Ethernet5]
      ...
      bdlink %w[AS65520-2 Ethernet4 Seg_10.130.0.0/24 AS65520-2_Ethernet4]
